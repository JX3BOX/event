<template>
    <div class="m-content">
        <div class="m-page-tabs">
            ...
            <div class="m-item" v-for="(item, index) in 8" :key="index">
                <img class="u-img" :src="require(`../../assets/img/celebration/nav/${item}.svg`)" alt="">
            </div>
        </div>
        <div class="m-page-0">
            ...
            <div class="m-main">
                ...
                <div class="m-fun">
                    <div class="m-item" v-for="(item,index) in page4Arr" :key="index">
                        <img class="u-fun__img" :src="require(`../../assets/img/celebration/4/V${index+1}.svg`)" alt="">
        ...
        <div class="m-page-6 m-page-layout">
            ...
            <img class="u-bg" src="../../assets/img/celebration/6/bg.jpg" alt="">
            <div class="m-main">
                <img class="u-title" src="../../assets/img/celebration/6/title.svg" alt="">
                <div class="m-info">
                    <div class="u-top">B5 40P横线本 4选1</div>
                    <div class="m-book">
                        <img class="u-book" v-for="item in 4" :key="item"
                             :src="require(`../../assets/img/celebration/6/book_${item}.png`)" alt="">
                    </div>
...
export default {
    ...
    data() {
        return {
            items: ["《我恨剑网3", "纪念勋章", "会员限定装扮", "魔盒会员新功能", "充会员返礼", "年费会员福利"],
            page4Arr: ["新功能提前体验", "团队应用高级功能", "个人战斗数据仓库", "魔盒助手高级功能", "专属虚拟装扮", "亲友名单无上限", "专属昵称尾巴标识", "签到双倍积分"],
        };
    },
    watch: {},
    created() {
